...
# 4 "lifegame.c" 2
# 29 "lifegame.c"
void print_func(int val[60][240]){
    for(int i = 0; i < 60; i++){
        for(int j = 0; j < 240; j++){
...
void define_init_val(int init_val[60][240]){
    int flag;

    for(int i = 0; i < 60; i++){
        for(int j = 0; j < 240; j++){
            flag = (int)( rand() * (2.0) / (1.0 + 0x7fffffff) );
            init_val[i][j] = flag;
        }
    }
}
...
void cp_first(int init_val[60][240], int prev_val[60][240]){
    for(int i = 0; i < 60; i++){
        for(int j = 0; j < 240; j++){
...
void cp_prev_to_next(int prev_val[60][240], int next_val[60][240]){
    for(int i = 0; i < 60; i++){
        for(int j = 0; j < 240; j++){
...
void generational_change(int prev_val[60][240], int next_val[60][240]){
    ...
    for(int i = 0; i < 60; i++){
        for(int j = 0; j < 240; j++){
            if( i == 0 ){
                ...
                if( j == 0 ) counter = prev_val[i][j + 1] + prev_val[i + 1][j] + prev_val[i + 1][j + 1];

                else if( j == 240 - 1 ) counter = prev_val[i][j - 1] + prev_val[i + 1][j - 1] + prev_val[i + 1][j];

                else counter = prev_val[i][j - 1] + prev_val[i][j + 1] + prev_val[i + 1][j - 1] + prev_val[i + 1][j] + prev_val[i + 1][j + 1];
            }else if(i == 60 - 1){

                if( j == 0 ) counter = prev_val[i - 1][j] + prev_val[i - 1][j + 1] + prev_val[i][j + 1];

                else if( j == 240 - 1 ) counter = prev_val[i - 1][j - 1] + prev_val[i - 1][j] + prev_val[i][j - 1];

                else counter = prev_val[i - 1][j - 1] + prev_val[i - 1][j] + prev_val[i - 1][j + 1] + prev_val[i][j - 1] + prev_val[i][j + 1];
            }else{

                if( j == 0 ) counter = prev_val[i - 1][j] + prev_val[i - 1][j + 1] + prev_val[i][j + 1] + prev_val[i + 1][j] + prev_val[i + 1][j + 1];

                else if( j == 240 - 1 ) counter = prev_val[i - 1][j - 1] + prev_val[i - 1][j] + prev_val[i][j - 1] + prev_val[i + 1][j - 1] + prev_val[i + 1][j];

                else counter = prev_val[i - 1][j - 1] + prev_val[i - 1][j] + prev_val[i - 1][j + 1] + prev_val[i][j - 1] + prev_val[i][j + 1] + prev_val[i + 1][j - 1] + prev_val[i + 1][j] + prev_val[i + 1][j + 1];
            }
